...
It's hard to navigate big blocks of text. UX practice tells us that "chunking" the content into smaller, more manageable bits makes it easier to consume. One method of chunking we saw that worked well to break up the big blocks of text was using subheadings throughout the page that told the user what they may find in that section, and minimized text within the section. The Syracuse site ([figure 1](https://gitlab.si.umich.edu/borromean/t22/raw/f3cbfd8829a6fa2028238a5af55c51813dee6b52/figure%201%20syracuse%20checklist.PNG)) checklist is an example of an effective layout. The use of large bulleted checklist item titles with smaller detail text is effective for two purposes: quick overview and find the information needed.
